...
from SaitamaRobot.function.pluginhelpers import convert_seconds_to_minutes as time_convert
from SaitamaRobot.function.pluginhelpers import fetch
from SaitamaRobot.services.pyrogram import pbot
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/f74aca0e735577065bb0c.mp4",
...
async def alive_function(answers):
    ...
    msg = f"""
**[NOBARA](https://github.com/Unknown-San/Nobara-Superbot):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/Nobara_Superbot)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/93d0117e57737e8b17cc2.jpg",
